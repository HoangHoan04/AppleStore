                                    ...
                                    <div class="category-card">
                                        <div class="category-info">
                                            ...
                                            <img src="../images/<?= $item['categoryImage']; ?>"
                                                alt="<?= $item['categoryName']; ?>" class="category-image">
                                            <p><?= $item['categoryDescription']; ?></p>
                                            <span
                                                class="badge <?= $item['categoryStatus'] == '1' ? 'bg-success' : 'bg-danger'; ?>">
                                                <?= $item['categoryStatus'] == '1' ? "Đang hiển thị" : "Đã Ẩn"; ?>
                                            </span>
                                            </p>
                                            <p class="">Ngày tạo: <?= $item['create_at']; ?></p>
                                        </div>
                                        <div class="category-actions">
                                            <a href="edit-category.php?categoryId=<?= $item['categoryId']; ?>"
